...
function Footer() {
  return (
    <footer className="relative w-full mt-20 bg-slate-200">
  <div className="w-full px-8 mx-auto max-w-7xl">
    <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
      <h5 className="mb-6 text-xl font-semibold text-slate-800 mt-11">
        Development by Intech
      </h5>
      <div className="grid justify-between grid-cols-3 gap-4">
        <ul>
          <p className="block mb-1 text-base font-semibold  text-slate-800 mt-11">
            Product
          </p>
          <li>
    ...
    <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
      ...
      <div className="flex gap-4 text-slate-600 sm:justify-center">
        ...
        <a href="https://www.instagram.com/incubator_stelkmks/" className="block transition-opacity text-inherit hover:opacity-80">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd"
